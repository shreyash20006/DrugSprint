          ...
          <div className="md:col-span-5 space-y-5">
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-3 text-xs sm:text-sm text-white/60">
              {[
                ...
                { name: '🎓 GPAT & NIPER Prep', path: '/gpat-prep' },
          ...
          <div className="md:col-span-3 space-y-5">
            ...
            <div className="flex space-x-3.5">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 rounded-xl bg-white/5 hover:bg-[#0077B5] hover:text-white flex items-center justify-center transition-all duration-300 border border-white/5 hover:scale-110 hover:rotate-6 hover:-translate-y-1 shadow-md shadow-black/20"
