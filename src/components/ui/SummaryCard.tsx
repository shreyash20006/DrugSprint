...
export const SummaryCard: React.FC<SummaryCardProps> = ({
  ...
  return (
    ...
    >
      <div className="relative rounded-3xl bg-gradient-to-br from-[#0D1B3E]/90 to-[#0A1428]/95 border border-orange-burnt/25 backdrop-blur-2xl overflow-hidden shadow-[0_20px_50px_-20px_rgba(0,0,0,0.6)]">
        {/* Decorative corner accents */}
        <div className="absolute -top-px -left-px w-12 h-12 border-t-2 border-l-2 border-orange-burnt/55 rounded-tl-3xl pointer-events-none" />
        ...
        <div className="relative px-7 py-5 border-b border-white/[0.06] flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-orange-burnt to-[#E06D2B] flex items-center justify-center shadow-lg shadow-orange-burnt/20">
            ...
            <div>
              ...
              <p className="text-[10px] text-orange-burnt font-bold tracking-[0.2em] uppercase mt-0.5 leading-none">
                Secure Checkout
              </p>
            </div>
          </div>
        ...
        <div className="relative px-7 py-5 space-y-4">
          ...
          <div className="space-y-1.5 py-2">
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-orange-burnt">
              {isFree ? 'Free Registration' : 'Total Amount'}
            </p>
            <div className="flex items-baseline gap-2">
              <span className="font-display font-extrabold text-5xl text-transparent bg-clip-text bg-gradient-to-r from-orange-burnt to-gold-accent leading-none tracking-tight">
          ...
          <p className="text-center text-[9px] text-white/35 font-sans pt-1">
            ...
            <a href="/terms" className="text-orange-burnt hover:text-gold-accent transition-colors underline-offset-2 hover:underline">
              Terms
            </a>{' '}
            &{' '}
            <a href="/refunds" className="text-orange-burnt hover:text-gold-accent transition-colors underline-offset-2 hover:underline">
              Refund Policy
            </a>
          </p>
        </div>
                  ...
                  <div className="flex flex-col items-center gap-1.5 flex-1">
                    <div
                      className={`w-9 h-9 rounded-xl flex items-center justify-center border ${
                        idx === 0
                          ? 'bg-orange-burnt/15 border-orange-burnt/35 text-orange-burnt'
                    ...
                    <span
                      className={`text-[9px] font-display font-bold uppercase tracking-wider text-center leading-tight ${
                        idx === 0 ? 'text-orange-burnt' : 'text-white/45'
                      }`}
                    >
                      {s.title}
                    </span>
