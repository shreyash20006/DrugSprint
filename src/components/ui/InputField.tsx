    ...
    return (
      <div className="space-y-1.5">
        ...
        <div
          ...
          } backdrop-blur-md focus-within:border-orange-burnt/55 focus-within:bg-[#050B18]/85 focus-within:shadow-[0_0_0_4px_rgba(214,90,30,0.12)]`}
        >
          {Icon && (
            <Icon
              className={`pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors ${
                error ? 'text-red-400' : 'text-white/35 group-focus-within:text-orange-burnt'
              }`}
              strokeWidth={2.2}
            />
          )}
