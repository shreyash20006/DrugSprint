    ...
    >
      ...
      <div className="p-6 flex flex-col h-full justify-between">
        <div>
          ...
          {/* Description */}
          <div className="text-white/70 text-sm leading-relaxed mb-6 font-sans whitespace-pre-wrap break-words text-left">
            {renderFormattedDescription(competition.description)}
          </div>
