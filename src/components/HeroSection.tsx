  ...
  const animationStyles = (
    <style>{`
      ...
      @keyframes pulse-glow {
        0%, 100% { box-shadow: 0 0 15px rgba(200, 75, 14, 0.3), 0 0 30px rgba(168, 85, 247, 0.1); }
        50% { box-shadow: 0 0 30px rgba(200, 75, 14, 0.5), 0 0 60px rgba(168, 85, 247, 0.3); }
      }
      .animate-float-slow {
            ...
            <div className="absolute inset-0 pointer-events-none z-20">
              ...
              <div className="absolute bottom-[18%] right-[0%] sm:right-[-8%] animate-float-fast pointer-events-auto">
                <div className="flex items-center space-x-2 px-3 py-2 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-md shadow-2xl hover:scale-105 transition-transform">
                  ...
                  <div className="flex flex-col text-left">
                    <span className="text-[9px] uppercase tracking-wider text-yellow-400 font-extrabold font-display leading-none">Google Auth</span>
